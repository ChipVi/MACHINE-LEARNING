...
grayImg = cv2.cvtColor(masked_image, cv2.COLOR_BGR2GRAY)
...
CannyEdge = cv2.Canny(blur, 70, 170)
...
HoughLines=cv2.HoughLinesP(CannyEdge, rho = p, theta = theta, threshold = threshold,
